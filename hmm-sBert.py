...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Optimization of Gaussian Mixture Model with BERT embeddings")
    
    # Data and Output Paths
    parser.add_argument('-i', '--input_file', type=str, required=True,
                        help='Path to the input dataset file')
    parser.add_argument('-o', '--output_dir', type=str, default='./Sent-en-GMM-Bert',
